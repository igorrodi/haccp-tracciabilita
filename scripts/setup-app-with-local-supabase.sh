...
# ============================================================================
# FASE 2: Avvio Supabase Locale
# ============================================================================

echo ""
print_info "FASE 2: Avvio Supabase locale con Docker..."

# Verifica Docker
if ! command -v docker &> /dev/null; then
    print_error "Docker non installato!"
    print_info "Installa Docker prima di continuare"
    exit 1
fi
...
print_info "Fermo eventuali container esistenti..."
docker compose down 2>/dev/null || true

# Avvia Supabase
print_info "Avvio Supabase locale..."
docker compose up -d
...
if ! docker compose ps | grep -q "db.*running"; then
    print_error "Il container del database non è in esecuzione!"
    docker compose logs db
    exit 1
fi

print_status "Supabase avviato!"

# ============================================================================
# FASE 3: Applica Migrazioni Database
# ============================================================================

echo ""
print_info "FASE 3: Creazione tabelle nel database..."
...
# Applica migrazioni usando docker exec
    ...
    for migration in supabase/migrations/*.sql; do
        if [ -f "$migration" ]; then
            ...
            docker exec -i $(docker compose -f scripts/docker/docker-compose.yml ps -q db) \
                psql -U postgres -d postgres < "$migration" 2>&1 | grep -v "NOTICE:" || {
...
# ============================================================================
# FASE 4: Configura Client Supabase per uso locale
# ============================================================================

echo ""
print_info "FASE 4: Configurazione client Supabase..."
...
# ============================================================================
# FASE 5: Installa Dipendenze e Build App
# ============================================================================

echo ""
print_info "FASE 5: Build applicazione..."
...
# ============================================================================
# FASE 6: Setup Docker per l'app
# ============================================================================

echo ""
print_info "FASE 6: Configurazione Docker..."
...
# ============================================================================
# FASE 7: Configura Nginx come Reverse Proxy
# ============================================================================

echo ""
print_info "FASE 7: Configurazione Nginx reverse proxy..."
